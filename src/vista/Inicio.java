...
public class Inicio {
    ...
    public static void main(String[] args) {
        ...
        switch (opcion){
            ...
            case 3:
                byte tratamientos_dcl = 4;
                float valor_tratamientos [] = {40.0f, 42.0f, 40.7f, 32.7f, 43.5f, 34.6f };
                /*double [][][] tabla_datos_dcl  = {{{35,4},{ 40,0},{40.7,2},{ 42,1f},{32.7,3},{34.6,5}},
                                                  {{42.3,3} ,{43.5,4},{ 42.7,0}, {42.6,5},{41.6,1},{ 30.6,2}},
                                                  {{41,5},{39.5,2},{39.1,3},{ 38.8,4},{42.4,0},{31.1,1}},
                ...
                System.out.println("\n\n");
                System.out.println("grados libertad Hilera "+ controlador_dcl.datosHilera().getGrados_libertad());
                System.out.println("suma cuadrados Hilera "+ controlador_dcl.datosHilera().getSuma_cuadrados());
                System.out.println("cuadrado medio Hilera "+ controlador_dcl.datosHilera().getCuadrado_medio());
                System.out.println("F Calculada Hilera "+ controlador_dcl.datosHilera().getF_calculada());
                System.out.println("\n\n");
               
                System.out.println("grados libertad Columna "+ controlador_dcl.datosColumna().getGrados_libertad());
                System.out.println("suma cuadrados Columna "+ controlador_dcl.datosColumna().getSuma_cuadrados());
                System.out.println("cuadrado medio Columna "+ controlador_dcl.datosColumna().getCuadrado_medio());
                System.out.println("F Calculada Columna "+ controlador_dcl.datosColumna().getF_calculada());
                 System.out.println("\n\n");
